...
import app.philm.in.controllers.MovieController.MovieFilter;
...
public final class ApplicationState implements BaseState, MoviesState, UserState {
    ...
    public ApplicationState(Bus eventBus) {
        ...
        mTmdbIdMovies = new ArrayMap<String, PhilmMovie>(INITIAL_MOVIE_MAP_CAPACITY);
        mImdbIdMovies = new ArrayMap<String, PhilmMovie>(INITIAL_MOVIE_MAP_CAPACITY);
        mPeople = new ArrayMap<String, PhilmPerson>();
    }
    ...
    public Set<MovieController.MovieFilter> getFilters() {
        if (mFilters == null) {
            mFilters = new HashSet<MovieFilter>();
        }
        return mFilters;
    }
